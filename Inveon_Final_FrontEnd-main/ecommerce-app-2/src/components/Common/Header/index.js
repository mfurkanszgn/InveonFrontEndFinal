...
const Header = () => {
    ...
    const rmCartProduct = async (id) => {
        ...
        debugger;
        triggerRmCartPr = true;
        // try {
        //     await shoppingCartService.removeCart(id);
        // } catch (err) {
        //     console.log("Error Romevo Cart with id: " + id);
        // }
    }
